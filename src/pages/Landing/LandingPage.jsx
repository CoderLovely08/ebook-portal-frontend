  ...
  const featuresData = [
    {
      ...
      description: "Access thousands of premium ebooks across all genres with our comprehensive digital collection.",
      features: [
    ...
    {
      title: "Smart Reading",
      description: "Enhanced reading experience with personalized recommendations and smart bookmarking system.",
      features: [
    ...
    },
    {
      ...
      description: "Share your favorite books with family members and manage reading preferences for children.",
      features: [
        "Up to 6 profiles",
        "Parental controls",
        "Shared libraries",
        ...
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">Digital Reading Platform</p>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="flex flex-col items-center text-center mb-12">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-2xl">
                Discover a world of knowledge with BookVerse's extensive collection of ebooks,
                personalized recommendations, and seamless reading experience.
              </p>
              <div className="flex gap-4">
                ...
                <button className="px-6 py-3 bg-white text-green-600 border border-green-200 rounded-lg hover:bg-green-50 flex items-center gap-2">
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Our platform provides a complete suite of features for an immersive and
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Find your next favorite read from our carefully curated collection of books
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { name: "Fiction", icon: "📚", color: "bg-green-50" },
              { name: "Business", icon: "💼", color: "bg-green-50" },
              { name: "Science", icon: "🔬", color: "bg-green-50" },
              { name: "Technology", icon: "💻", color: "bg-green-50" },
              { name: "Self-Help", icon: "🧠", color: "bg-green-50" },
              { name: "History", icon: "🏛️", color: "bg-green-50" },
              { name: "Biography", icon: "👤", color: "bg-green-50" },
        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Join millions of readers who have already discovered the joy of digital reading
              with BookVerse.
            </p>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              ...
              <p className="text-gray-600">
                Your digital reading companion. Access thousands of books anytime, anywhere.
              </p>
            </div>
